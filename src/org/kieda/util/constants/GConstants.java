package org.kieda.util.constants;

import java.awt.Dimension;
import java.awt.Toolkit;
/**
 * simple universal graphics constants. Currently only the
 * screen width and height.
 * also carries bounds, in case if the user is inclined to use
 * it. Disp is backed by GConstant's bounds.
 */
